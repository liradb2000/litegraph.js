...
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(u, r, x) {
  u != Array.prototype && u != Object.prototype && (u[r] = x.value);
};
$jscomp.getGlobal = function(u) {
  return "undefined" != typeof window && window === u ? u : "undefined" != typeof global && null != global ? global : u;
};
$jscomp.global = $jscomp.getGlobal(this);
$jscomp.polyfill = function(u, r, x, p) {
  if (r) {
    x = $jscomp.global;
    u = u.split(".");
    ...
    p = x[u];
    r = r(p);
    r != p && null != r && $jscomp.defineProperty(x, u, {configurable:!0, writable:!0, value:r});
  }
};
$jscomp.polyfill("Array.prototype.fill", function(u) {
  return u ? u : function(r, u, p) {
    var x = this.length || 0;
    0 > u && (u = Math.max(0, x + u));
    if (null == p || p > x) {
      p = x;
    }
    p = Number(p);
    0 > p && (p = Math.max(0, x + p));
    for (u = Number(u || 0); u < p; u++) {
      this[u] = r;
    }
    return this;
  };
...
$jscomp.Symbol = function() {
  var u = 0;
  return function(r) {
    return $jscomp.SYMBOL_PREFIX + (r || "") + u++;
  };
}();
...
$jscomp.arrayIterator = function(u) {
  ...
  return $jscomp.iteratorPrototype(function() {
    return r < u.length ? {done:!1, value:u[r++]} : {done:!0};
  });
};
...
$jscomp.iteratorFromArray = function(u, r) {
  $jscomp.initSymbolIterator();
  u instanceof String && (u += "");
  var x = 0, p = {next:function() {
    if (x < u.length) {
      var z = x++;
      return {value:r(z, u[z]), done:!1};
    }
    p.next = function() {
...
$jscomp.polyfill("Array.prototype.values", function(u) {
  return u ? u : function() {
    return $jscomp.iteratorFromArray(this, function(r, u) {
      return u;
    });
  };
}, "es8", "es3");
...
$jscomp.owns = function(u, r) {
  return Object.prototype.hasOwnProperty.call(u, r);
};
$jscomp.polyfill("Object.values", function(u) {
  return u ? u : function(r) {
    var u = [], p;
    for (p in r) {
      $jscomp.owns(r, p) && u.push(r[p]);
    }
    return u;
  };
}, "es8", "es3");
(function(u) {
  ...
  function B(a, b, c, d, e, h) {
    return c < a && c + e > a && d < b && d + h > b ? !0 : !1;
  }
  function H(a, b) {
  ...
  function E(a, b) {
    function c(a) {
      ...
      h.style.top = (c + a.deltaY * b.scroll_speed).toFixed() + "px";
      a.preventDefault();
      return !0;
    }
    this.options = b = b || {};
    ...
    e = b.left || 0;
    a = b.top || 0;
    b.event && (e = b.event.clientX - 10, a = b.event.clientY - 10, b.title && (a -= 20), b.parentMenu && (e = b.parentMenu.root.getBoundingClientRect(), e = e.left + e.width), g = document.body.getBoundingClientRect(), f = h.getBoundingClientRect(), 0 == g.height && console.error("document.body height is 0. That is dangerous, set html,body { height: 100%; }"), g.width && e > g.width - f.width - 10 && (e = g.width - f.width - 10), g.height && a > g.height - f.height - 10 && (a = g.height - f.height - 
    10));
    h.style.left = e + "px";
    h.style.top = a + "px";
  ...
  ON_TRIGGER:3, UP:1, DOWN:2, LEFT:3, RIGHT:4, CENTER:5, STRAIGHT_LINK:0, LINEAR_LINK:1, SPLINE_LINK:2, NORMAL_TITLE:0, NO_TITLE:1, TRANSPARENT_TITLE:2, AUTOHIDE_TITLE:3, proxy:null, node_images_path:"", debug:!1, catch_exceptions:!0, throw_errors:!0, allow_scripts:!1, registered_node_types:{}, node_types_by_file_extension:{}, Nodes:{}, Globals:{}, searchbox_extras:{}, registerNodeType:function(a, b) {
    ...
    if (d = this.registered_node_types[a]) {
      ...
      if (Object.hasOwnProperty(b.prototype, "shape") || Object.defineProperty(b.prototype, "shape", {set:function(a) {
        ...
        for (e in b.supported_extensions) {
          var h = b.supported_extensions[e];
          h && h.constructor === String && (this.node_types_by_file_extension[h.toLowerCase()] = b);
        }
      }
    }
    ...
    if (b.supported_extensions) {
      for (e = 0; e < b.supported_extensions.length; e++) {
        (h = b.supported_extensions[e]) && h.constructor === String && (this.node_types_by_file_extension[h.toLowerCase()] = b);
      }
    }
    ...
    for (var h = Array(b.length), g = "", k = f.getParameterNames(b), l = 0; l < k.length; ++l) {
      g += "this.addInput('" + k[l] + "'," + (c && c[l] ? "'" + c[l] + "'" : "0") + ");\n";
    }
    ...
    if (h) {
      ...
      if (b) {
        for (var g = 0; g < a; g++) {
          for (var k = 0; k < c; ++k) {
            var l = h[k];
            if (l.mode == f.ALWAYS && l.onExecute) {
              switch(l.onExecute(), d) {
                case "3d":
                  l.on3DExecute && l.on3DExecute();
                  break;
                case "frame":
                  l.onFrameExecute && l.onFrameExecute();
                  break;
                case "2d":
                  l.on2DExecute && l.on2DExecute();
              }
            }
          }
        ...
        try {
          for (g = 0; g < a; g++) {
            for (k = 0; k < c; ++k) {
              if (l = h[k], l.mode == f.ALWAYS && l.onExecute) {
                switch(l.onExecute(), d) {
                  case "3d":
                    l.on3DExecute && l.on3DExecute();
                    break;
          ...
          f.debug && console.log("Error during execution: " + t);
          this.stop();
        }
      }
      a = f.getTime();
  ...
  r.prototype.computeExecutionOrder = function(a, b) {
    for (var c = [], d = [], e = {}, h = {}, g = {}, k = 0, l = this._nodes.length; k < l; ++k) {
      var t = this._nodes[k];
      if (!a || t.onExecute) {
        e[t.id] = t;
        var q = 0;
        if (t.inputs) {
          for (var n = 0, m = t.inputs.length; n < m; n++) {
            t.inputs[n] && null != t.inputs[n].link && (q += 1);
          }
        }
        0 == q ? (d.push(t), b && (t._level = 1)) : (b && (t._level = 0), g[t.id] = q);
      }
    }
    for (; 0 != d.length;) {
      if (t = d.shift(), c.push(t), delete e[t.id], t.outputs) {
        for (k = 0; k < t.outputs.length; k++) {
          if (a = t.outputs[k], null != a && null != a.links && 0 != a.links.length) {
            for (n = 0; n < a.links.length; n++) {
              (l = this.links[a.links[n]]) && !h[l.id] && (q = this.getNodeById(l.target_id), null == q ? h[l.id] = !0 : (b && (!q._level || q._level <= t._level) && (q._level = t._level + 1), h[l.id] = !0, --g[q.id], 0 == g[q.id] && d.push(q)));
            }
          }
        }
      }
  ...
  r.prototype.getAncestors = function(a) {
    for (var b = [], c = [a], d = {}; c.length;) {
      ...
      if (e.inputs) {
        ...
        for (var h = 0; h < e.inputs.length; ++h) {
          var g = e.getInputNode(h);
  ...
  r.prototype.arrange = function(a) {
    ...
    for (d = 0; d < c.length; ++d) {
      if (h = c[d]) {
        for (var g = 100, k = a + f.NODE_TITLE_HEIGHT, l = 0; l < h.length; ++l) {
          e = h[l], e.pos[0] = b, e.pos[1] = k, e.size[0] > g && (g = e.size[0]), k += e.size[1] + a + f.NODE_TITLE_HEIGHT;
        }
        b += g + a;
      }
    }
  ...
  r.prototype.getNodeOnPos = function(a, b, c, d) {
    c = c || this._nodes;
    for (var e = c.length - 1; 0 <= e; e--) {
      var h = c[e];
      if (h.isPointInside(a, b, d)) {
        return h;
      }
    }
    return null;
  ...
  r.prototype.beforeChange = function(a) {
    if (this.onBeforeChange) {
      this.onBeforeChange(this, a);
    }
    this.sendActionToCanvas("onBeforeChange", this);
  };
  r.prototype.afterChange = function(a) {
  ...
  r.prototype.serialize = function() {
    ...
    a = {last_node_id:this.last_node_id, last_link_id:this.last_link_id, nodes:a, links:c, groups:h, config:this.config, extra:this.extra, version:f.VERSION};
    if (this.onSerialize) {
      this.onSerialize(a);
    }
    return a;
    ...
    if (a) {
      ...
      if (b) {
        ...
        for (e = b.length; d < e; ++d) {
          h = b[d];
          var g = f.createNode(h.type, h.title);
          g || (f.debug && console.log("Node not found or has errors: " + h.type), g = new p, g.last_serialization = h, c = g.has_errors = !0);
          g.id = h.id;
          this.add(g, !0);
        }
        d = 0;
        for (e = b.length; d < e; ++d) {
          h = b[d], (g = this.getNodeById(h.id)) && g.configure(h);
        }
      }
    ...
    if (this.outputs && (a = this.outputs[a]) && (a = a.links) && a.length) {
      ...
      for (var d = 0; d < a.length; ++d) {
        ...
        if (null == c || c == e) {
          ...
          if (h && (h._last_time = f.getTime(), e = this.graph.getNodeById(h.target_id))) {
            if (h = e.inputs[h.target_slot], e.mode === f.ON_TRIGGER) {
              if (e.onExecute) {
                e.onExecute(b);
              }
            } else {
  ...
  p.prototype.computeSize = function(a) {
    ...
    c = Math.max(c, 1);
    var d = f.NODE_TEXT_SIZE, e = b(this.title), h = 0, g = 0;
    if (this.inputs) {
      for (var k = 0, l = this.inputs.length; k < l; ++k) {
        var t = this.inputs[k];
        t = t.label || t.name || "";
        t = b(t);
        h < t && (h = t);
    ...
    if (this.outputs) {
      for (k = 0, l = this.outputs.length; k < l; ++k) {
        t = this.outputs[k], t = t.label || t.name || "", t = b(t), g < t && (g = t);
      }
    }
    a[0] = Math.max(h + g + 10, e);
    ...
    if (this.widgets && this.widgets.length) {
      k = 0;
      for (l = this.widgets.length; k < l; ++k) {
        c = this.widgets[k].computeSize ? c + (this.widgets[k].computeSize(a[0])[1] + 4) : c + (f.NODE_WIDGET_HEIGHT + 4);
      }
      c += 8;
    }
  ...
  p.prototype.isPointInside = function(a, b, c, d) {
    ...
    if (this.flags && this.flags.collapsed) {
      if (B(a, b, this.pos[0] - c, this.pos[1] - f.NODE_TITLE_HEIGHT - c, (this._collapsed_width || f.NODE_COLLAPSED_WIDTH) + 2 * c, f.NODE_TITLE_HEIGHT + 2 * c)) {
        return !0;
      }
    } else {
    ...
    if (this.inputs) {
      for (var d = 0, e = this.inputs.length; d < e; ++d) {
        ...
        if (B(a, b, c[0] - 10, c[1] - 5, 20, 10)) {
          return {input:h, slot:d, link_pos:c};
        }
      }
    }
    if (this.outputs) {
      for (d = 0, e = this.outputs.length; d < e; ++d) {
        if (h = this.outputs[d], this.getConnectionPos(!1, d, c), B(a, b, c[0] - 10, c[1] - 5, 20, 10)) {
          return {output:h, slot:d, link_pos:c};
        }
      }
    }
    return null;
  ...
  p.prototype.connect = function(a, b, c) {
    ...
    var h = b.inputs[c], g = null;
    if (!f.isValidConnection(e.type, h.type)) {
      return this.setDirtyCanvas(!1, !0), d && this.graph.connectionChange(this, g), null;
    }
    d || this.graph.beforeChange();
    g = new x(++this.graph.last_link_id, h.type, this.id, a, b.id, c);
    ...
    if (b.onConnectionsChange) {
      b.onConnectionsChange(f.INPUT, c, !0, g, h);
    }
  ...
  p.prototype.disconnectOutput = function(a, b) {
    ...
    if (b) {
      ...
      for (var d = 0, e = c.links.length; d < e; d++) {
        var h = c.links[d], g = this.graph.links[h];
        if (g.target_id == b.id) {
          c.links.splice(d, 1);
          var k = b.inputs[g.target_slot];
          k.link = null;
          delete this.graph.links[h];
          this.graph && this.graph._version++;
          if (b.onConnectionsChange) {
            b.onConnectionsChange(f.INPUT, g.target_slot, !1, g, k);
          }
          if (this.onConnectionsChange) {
      ...
      for (e = c.links.length; d < e; d++) {
        if (h = c.links[d], g = this.graph.links[h]) {
          b = this.graph.getNodeById(g.target_id);
          this.graph && this.graph._version++;
          if (b) {
            k = b.inputs[g.target_slot];
            k.link = null;
            if (b.onConnectionsChange) {
              b.onConnectionsChange(f.INPUT, g.target_slot, !1, g, k);
            }
  ...
  p.prototype.disconnectInput = function(a) {
    ...
    if (null != c) {
      ...
      if (d) {
        ...
        var h = e.outputs[d.origin_slot];
        if (!h || !h.links || 0 == h.links.length) {
          return !1;
        }
        for (var g = 0, k = h.links.length; g < k; g++) {
          if (h.links[g] == c) {
            h.links.splice(g, 1);
            break;
          }
        ...
        if (e.onConnectionsChange) {
          e.onConnectionsChange(f.OUTPUT, g, !1, d, h);
        }
  ...
  u.LGraphGroup = f.LGraphGroup = z;
  z.prototype._ctor = function(a) {
    this.title = a || "Group";
    this.font_size = 24;
  ...
  z.prototype.serialize = function() {
  ...
  z.prototype.move = function(a, b, c) {
    this._pos[0] += a;
    this._pos[1] += b;
    if (!c) {
  ...
  z.prototype.recomputeInsideNodes = function() {
    this._nodes.length = 0;
    for (var a = this.graph._nodes, b = new Float32Array(4), c = 0; c < a.length; ++c) {
      var d = a[c];
      d.getBounding(b);
      H(this._bounding, b) && this._nodes.push(d);
    }
  };
  z.prototype.isPointInside = p.prototype.isPointInside;
  z.prototype.setDirtyCanvas = p.prototype.setDirtyCanvas;
  f.DragAndScale = A;
  ...
  A.prototype.computeVisibleArea = function() {
    if (this.element) {
  ...
  u.LGraphCanvas = f.LGraphCanvas = m;
  ...
  m.prototype.processMouseDown = function(a) {
    ...
    if (this.graph) {
      ...
      var d = this.graph.getNodeOnPos(a.canvasX, a.canvasY, this.visible_nodes, 5), e = !1, h = 300 > f.getTime() - this.last_mouseclick;
        ...
        if (1 == a.which) {
          ...
          if (d && this.allow_interaction && !e && !this.read_only) {
            ...
            if (!this.connecting_node && !d.flags.collapsed && !this.live_mode) {
              if (!e && !1 !== d.resizable && B(a.canvasX, a.canvasY, d.pos[0] + d.size[0] - 5, d.pos[1] + d.size[1] - 5, 10, 10)) {
                this.graph.beforeChange(), this.resizing_node = d, this.canvas.style.cursor = "se-resize", e = !0;
              } else {
                if (d.outputs) {
                  for (var k = 0, l = d.outputs.length; k < l; ++k) {
                    var t = d.outputs[k], q = d.getConnectionPos(!1, k);
                    if (B(a.canvasX, a.canvasY, q[0] - 15, q[1] - 10, 30, 20)) {
                ...
                if (d.inputs) {
                  for (k = 0, l = d.inputs.length; k < l; ++k) {
                    if (t = d.inputs[k], q = d.getConnectionPos(!0, k), B(a.canvasX, a.canvasY, q[0] - 15, q[1] - 10, 30, 20)) {
                      if (h) {
            ...
            if (!e) {
              k = !1;
              l = [a.canvasX - d.pos[0], a.canvasY - d.pos[1]];
              if (q = this.processNodeWidgets(d, this.graph_mouse, a)) {
                k = !0, this.node_widget = [d, q];
              }
              if (h && this.selected_nodes[d.id]) {
                if (d.onDblClick) {
                  d.onDblClick(a, l, this);
                }
                this.processNodeDblClicked(d);
                k = !0;
              }
              d.onMouseDown && d.onMouseDown(a, l, this) ? k = !0 : (d.subgraph && !d.skip_subgraph_button && !d.flags.collapsed && l[0] > d.size[0] - f.NODE_TITLE_HEIGHT && 0 > l[1] && (c = this, setTimeout(function() {
                c.openSubgraph(d.subgraph);
              }, 10)), this.live_mode && (k = g = !0));
              k || (this.allow_dragnodes && (this.graph.beforeChange(), this.node_dragged = d), this.selected_nodes[d.id] || this.processNodeSelected(d, a));
              this.dirty_canvas = !0;
            }
          } else {
            if (!this.read_only) {
              for (k = 0; k < this.visible_links.length; ++k) {
                if (g = this.visible_links[k], l = g._pos, !(!l || a.canvasX < l[0] - 4 || a.canvasX > l[0] + 4 || a.canvasY < l[1] - 4 || a.canvasY > l[1] + 4)) {
            ...
            this.selected_group && !this.read_only && (a.ctrlKey && (this.dragging_rectangle = null), 10 > J([a.canvasX, a.canvasY], [this.selected_group.pos[0] + this.selected_group.size[0], this.selected_group.pos[1] + this.selected_group.size[1]]) * this.ds.scale ? this.selected_group_resizing = !0 : this.selected_group.recomputeInsideNodes());
            ...
            if (this.allow_interaction && !this.read_only) {
              ...
              if (d) {
                ...
                if (this.connecting_node && (e = this._highlight_input || [0, 0], !this.isOverNodeBox(d, a.canvasX, a.canvasY))) {
                  var h = this.isOverNodeInput(d, a.canvasX, a.canvasY, e);
                  -1 != h && d.inputs[h] ? f.isValidConnection(this.connecting_output.type, d.inputs[h].type) && (this._highlight_input = e) : this._highlight_input = null;
                }
      ...
      if (1 == a.which) {
        ...
        !0), this.selected_group = null), this.selected_group_resizing = !1, this.dragging_rectangle) {
          if (this.graph) {
            ...
            var d = Math.abs(this.dragging_rectangle[2]), e = Math.abs(this.dragging_rectangle[3]), h = 0 > this.dragging_rectangle[3] ? this.dragging_rectangle[1] - e : this.dragging_rectangle[1];
            ...
            for (h = 0; h < b.length; ++h) {
              d = b[h], d.getBounding(c), H(this.dragging_rectangle, c) && e.push(d);
            }
          ...
          if (this.connecting_node) {
            ...
            if (this.resizing_node) {
              ...
              if (this.node_dragged) {
                (d = this.node_dragged) && 300 > a.click_time && B(a.canvasX, a.canvasY, d.pos[0], d.pos[1] - f.NODE_TITLE_HEIGHT, f.NODE_TITLE_HEIGHT, f.NODE_TITLE_HEIGHT) && d.collapse();
                this.dirty_bgcanvas = this.dirty_canvas = !0;
  ...
  m.prototype.isOverNodeBox = function(a, b, c) {
    ...
    return B(b, c, a.pos[0] + 2, a.pos[1] + 2 - d, d - 4, d - 4) ? !0 : !1;
  };
  m.prototype.isOverNodeInput = function(a, b, c, d) {
    if (a.inputs) {
      for (var e = 0, h = a.inputs.length; e < h; ++e) {
        var g = a.getConnectionPos(!0, e);
        if (a.horizontal ? B(b, c, g[0] - 5, g[1] - 10, 10, 20) : B(b, c, g[0] - 10, g[1] - 5, 40, 10)) {
        ...
        if (a.nodes.push(b.serialize()), e.inputs && e.inputs.length) {
          for (b = 0; b < e.inputs.length; ++b) {
            ...
            if (h && null != h.link && (h = this.graph.links[h.link])) {
              var g = this.graph.getNodeById(h.origin_id);
              g && this.selected_nodes[g.id] && a.links.push([g._relative_id, h.origin_slot, e._relative_id, h.target_slot]);
            }
          }
        }
      } else {
  ...
  m.prototype.pasteFromClipboard = function() {
    ...
    if (a) {
      ...
      for (c = 0; c < a.links.length; ++c) {
        ...
        e = b[d[0]];
        var h = b[d[2]];
        e && h ? e.connect(d[1], h, d[3]) : console.warn("Warning, nodes missing on pasting");
      }
      this.selectNodes(b);
      this.graph.afterChange();
    }
  ...
  m.prototype.processDrop = function(a) {
    ...
    if (c) {
      if ((c.onDropFile || c.onDropData) && (b = a.dataTransfer.files) && b.length) {
        for (var d = 0; d < b.length; d++) {
          var e = a.dataTransfer.files[0], h = e.name;
          m.getFileExtension(h);
          if (c.onDropFile) {
            c.onDropFile(e);
          }
          if (c.onDropData) {
            ...
            g.onload = function(a) {
              c.onDropData(a.target.result, h, e);
            };
    ...
    for (var a in this.selected_nodes) {
      ...
      if (!b.block_delete) {
        if (b.inputs && b.inputs.length && b.outputs && b.outputs.length && f.isValidConnection(b.inputs[0].type, b.outputs[0].type) && b.inputs[0].link && b.outputs[0].links && b.outputs[0].links.length) {
          var c = b.graph.links[b.inputs[0].link], d = b.graph.links[b.outputs[0].links[0]], e = b.getInputNode(0), h = b.getOutputNodes(0)[0];
          e && h && e.connect(c.origin_slot, h, d.target_slot);
        }
        this.graph.remove(b);
        if (this.onNodeDeselected) {
  ...
  m.prototype.computeVisibleNodes = function(a, b) {
    ...
    for (var c = 0, d = a.length; c < d; ++c) {
      var e = a[c];
      (!this.live_mode || e.onDrawBackground || e.onDrawForeground) && H(this.visible_area, e.getBounding(K)) && b.push(e);
    }
    return b;
  };
  ...
  m.prototype.drawSubgraphPanel = function(a) {
    ...
    if (c) {
      ...
      if (this.drawButton(280, 20, 20, 20, "X", "#151515")) {
        ...
        a.font = "20px Arial";
        if (c.inputs) {
          for (var h = 0; h < c.inputs.length; ++h) {
            var g = c.inputs[h];
            if (!g.not_subgraph_input) {
              if (this.drawButton(20, d + 2, 280, e - 2)) {
                var k = c.constructor.input_node_type || "graph/input";
                this.graph.beforeChange();
                var l = f.createNode(k);
                l ? (b.add(l), this.block_click = !1, this.last_click_position = null, this.selectNodes([l]), this.node_dragged = l, this.dragging_canvas = !1, l.setProperty("name", g.name), l.setProperty("type", g.type), this.node_dragged.pos[0] = this.graph_mouse[0] - 5, this.node_dragged.pos[1] = this.graph_mouse[1] - 5, this.graph.afterChange()) : console.error("graph input node not found:", k);
              }
              a.fillStyle = "#9C9";
              a.beginPath();
              ...
              k = a.measureText(g.name);
              a.fillStyle = "#777";
              a.fillText(g.type, 50 + k.width + 10, d + 0.75 * e);
              d += e;
            }
          }
        }
  ...
  m.prototype.drawButton = function(a, b, c, d, e, h, g, k) {
    var l = this.ctx;
    h = h || f.NODE_DEFAULT_COLOR;
    g = g || "#555";
    k = k || f.NODE_TEXT_COLOR;
    var t = this.mouse, q = f.isInsideRectangle(t[0], t[1], a, b, c, d);
    t = (t = this.last_click_position) && f.isInsideRectangle(t[0], t[1], a, b, c, d);
    l.fillStyle = q ? g : h;
    t && (l.fillStyle = "#AAA");
    l.beginPath();
    l.roundRect(a, b, c, d, 4);
    l.fill();
    null != e && e.constructor == String && (l.fillStyle = k, l.textAlign = "center", l.font = (0.65 * d | 0) + "px Arial", l.fillText(e, a + 0.5 * c, b + 0.75 * d), l.textAlign = "left");
    a = t && !this.block_click;
    t && this.blockClick();
    return a;
  };
  m.prototype.isAreaClicked = function(a, b, c, d, e) {
    var h = this.mouse;
    f.isInsideRectangle(h[0], h[1], a, b, c, d);
    b = (a = (h = this.last_click_position) && f.isInsideRectangle(h[0], h[1], a, b, c, d)) && !this.block_click;
    a && e && this.blockClick();
    return b;
  };
    ...
    if (this.live_mode) {
      ...
      if (!a.flags.collapsed || !a.onDrawCollapsed || 1 != a.onDrawCollapsed(b, this)) {
        ...
        if (a.flags.collapsed) {
          ...
          null != l && (a._collapsed_width = Math.min(a.size[0], b.measureText(l).width + 2 * f.NODE_TITLE_HEIGHT), C[0] = a._collapsed_width, C[1] = 0);
        }
        a.clip_area && (b.save(), b.beginPath(), g == f.BOX_SHAPE ? b.rect(0, 0, C[0], C[1]) : g == f.ROUND_SHAPE ? b.roundRect(0, 0, C[0], C[1], 10) : g == f.CIRCLE_SHAPE && b.arc(0.5 * C[0], 0.5 * C[1], 0.5 * C[0], 0, 2 * Math.PI), b.clip());
        a.has_errors && (d = "red");
        this.drawNodeShape(a, b, C, c, d, a.is_selected, a.mouseOver);
        ...
        if (!a.flags.collapsed) {
          if (a.inputs) {
            for (c = 0; c < a.inputs.length; c++) {
              var q = a.inputs[c];
              b.globalAlpha = h;
              this.connecting_node && !f.isValidConnection(q.type, g.type) && (b.globalAlpha = 0.4 * h);
              b.fillStyle = null != q.link ? q.color_on || this.default_connection_color.input_on : q.color_off || this.default_connection_color.input_off;
              var n = a.getConnectionPos(!0, c, t);
              n[0] -= a.pos[0];
              n[1] -= a.pos[1];
              l < n[1] + 0.5 * f.NODE_SLOT_HEIGHT && (l = n[1] + 0.5 * f.NODE_SLOT_HEIGHT);
              b.beginPath();
              q.type === f.EVENT || q.shape === f.BOX_SHAPE ? k ? b.rect(n[0] - 5 + 0.5, n[1] - 8 + 0.5, 10, 14) : b.rect(n[0] - 6 + 0.5, n[1] - 5 + 0.5, 14, 10) : q.shape === f.ARROW_SHAPE ? (b.moveTo(n[0] + 8, n[1] + 0.5), b.lineTo(n[0] - 4, n[1] + 6 + 0.5), b.lineTo(n[0] - 4, n[1] - 6 + 0.5), b.closePath()) : e ? b.rect(n[0] - 4, n[1] - 4, 8, 8) : b.arc(n[0], n[1], 4, 0, 2 * Math.PI);
              b.fill();
              if (d) {
                var m = null != q.label ? q.label : q.name;
                m && (b.fillStyle = f.NODE_TEXT_COLOR, k || q.dir == f.UP ? b.fillText(m, n[0], n[1] - 10) : b.fillText(m, n[0] + 10, n[1] + 5));
              }
            }
          }
          ...
          if (a.outputs) {
            for (c = 0; c < a.outputs.length; c++) {
              if (q = a.outputs[c], n = a.getConnectionPos(!1, c, t), n[0] -= a.pos[0], n[1] -= a.pos[1], l < n[1] + 0.5 * f.NODE_SLOT_HEIGHT && (l = n[1] + 0.5 * f.NODE_SLOT_HEIGHT), b.fillStyle = q.links && q.links.length ? q.color_on || this.default_connection_color.output_on : q.color_off || this.default_connection_color.output_off, b.beginPath(), q.type === f.EVENT || q.shape === f.BOX_SHAPE ? k ? b.rect(n[0] - 5 + 0.5, n[1] - 8 + 0.5, 10, 14) : b.rect(n[0] - 6 + 0.5, n[1] - 5 + 0.5, 14, 10) : 
              q.shape === f.ARROW_SHAPE ? (b.moveTo(n[0] + 8, n[1] + 0.5), b.lineTo(n[0] - 4, n[1] + 6 + 0.5), b.lineTo(n[0] - 4, n[1] - 6 + 0.5), b.closePath()) : e ? b.rect(n[0] - 4, n[1] - 4, 8, 8) : b.arc(n[0], n[1], 4, 0, 2 * Math.PI), b.fill(), e || b.stroke(), d && (m = null != q.label ? q.label : q.name)) {
                b.fillStyle = f.NODE_TEXT_COLOR, k || q.dir == f.DOWN ? b.fillText(m, n[0], n[1] - 8) : b.fillText(m, n[0] - 10, n[1] + 5);
              }
            }
          }
          b.textAlign = "left";
          ...
          if (this.render_collapsed_slots) {
            ...
            if (a.outputs) {
              for (c = 0; c < a.outputs.length; c++) {
                q = a.outputs[c], q.links && q.links.length && (e = q);
              }
            }
            h && (h = 0, c = -0.5 * f.NODE_TITLE_HEIGHT, k && (h = 0.5 * a._collapsed_width, c = -f.NODE_TITLE_HEIGHT), b.fillStyle = "#686", b.beginPath(), q.type === f.EVENT || q.shape === f.BOX_SHAPE ? b.rect(h - 7 + 0.5, c - 4, 14, 8) : q.shape === f.ARROW_SHAPE ? (b.moveTo(h + 8, c), b.lineTo(h + -4, c - 4), b.lineTo(h + -4, c + 4), b.closePath()) : b.arc(h, c, 4, 0, 2 * Math.PI), b.fill());
            e && (h = a._collapsed_width, c = -0.5 * f.NODE_TITLE_HEIGHT, k && (h = 0.5 * a._collapsed_width, c = 0), b.fillStyle = "#686", b.strokeStyle = "black", b.beginPath(), q.type === f.EVENT || q.shape === f.BOX_SHAPE ? b.rect(h - 7 + 0.5, c - 4, 14, 8) : q.shape === f.ARROW_SHAPE ? (b.moveTo(h + 6, c), b.lineTo(h - 6, c - 4), b.lineTo(h - 6, c + 4), b.closePath()) : b.arc(h, c, 4, 0, 2 * Math.PI), b.fill());
          }
        }
  ...
  m.prototype.drawNodeShape = function(a, b, c, d, e, h, g) {
    b.strokeStyle = d;
    b.fillStyle = e;
    e = f.NODE_TITLE_HEIGHT;
    var k = 0.5 > this.ds.scale, l = a._shape || a.constructor.shape || f.ROUND_SHAPE, t = a.constructor.title_mode, q = !0;
    t == f.TRANSPARENT_TITLE ? q = !1 : t == f.AUTOHIDE_TITLE && g && (q = !0);
    w[0] = 0;
    w[1] = q ? -e : 0;
    w[2] = c[0] + 1;
    w[3] = q ? c[1] + e : c[1];
    g = b.globalAlpha;
    b.beginPath();
    l == f.BOX_SHAPE || k ? b.fillRect(w[0], w[1], w[2], w[3]) : l == f.ROUND_SHAPE || l == f.CARD_SHAPE ? b.roundRect(w[0], w[1], w[2], w[3], this.round_radius, l == f.CARD_SHAPE ? 0 : this.round_radius) : l == f.CIRCLE_SHAPE && b.arc(0.5 * c[0], 0.5 * c[1], 0.5 * c[0], 0, 2 * Math.PI);
    b.fill();
    ...
    if (q || t == f.TRANSPARENT_TITLE) {
      if (a.onDrawTitleBar) {
        a.onDrawTitleBar(b, e, c, this.ds.scale, d);
      } else {
        if (t != f.TRANSPARENT_TITLE && (a.constructor.title_color || this.render_title_colored)) {
          q = a.constructor.title_color || d;
          a.flags.collapsed && (b.shadowColor = f.DEFAULT_SHADOW_COLOR);
          if (this.use_gradients) {
            var n = m.gradients[q];
            n || (n = m.gradients[q] = b.createLinearGradient(0, 0, 400, 0), n.addColorStop(0, q), n.addColorStop(1, "#000"));
            b.fillStyle = n;
          } else {
            b.fillStyle = q;
          }
          b.beginPath();
          l == f.BOX_SHAPE || k ? b.rect(0, -e, c[0] + 1, e) : (l == f.ROUND_SHAPE || l == f.CARD_SHAPE) && b.roundRect(0, -e, c[0] + 1, e, this.round_radius, a.flags.collapsed ? this.round_radius : 0);
          b.fill();
          b.shadowColor = "transparent";
        }
      }
      if (a.onDrawTitleBox) {
        ...
        l == f.ROUND_SHAPE || l == f.CIRCLE_SHAPE || l == f.CARD_SHAPE ? (k && (b.fillStyle = "black", b.beginPath(), b.arc(0.5 * e, -0.5 * e, 6, 0, 2 * Math.PI), b.fill()), b.fillStyle = a.boxcolor || f.NODE_DEFAULT_BOXCOLOR, k ? b.fillRect(0.5 * e - 5, -0.5 * e - 5, 10, 10) : (b.beginPath(), b.arc(0.5 * e, -0.5 * e, 5, 0, 2 * Math.PI), b.fill())) : (k && (b.fillStyle = "black", b.fillRect(0.5 * (e - 10) - 1, -0.5 * (e + 10) - 1, 12, 12)), b.fillStyle = a.boxcolor || f.NODE_DEFAULT_BOXCOLOR, b.fillRect(0.5 * 
        (e - 10), -0.5 * (e + 10), 10, 10));
      }
      b.globalAlpha = g;
      if (a.onDrawTitleText) {
        a.onDrawTitleText(b, e, c, this.ds.scale, this.title_text_font, h);
      }
      !k && (b.font = this.title_text_font, g = String(a.getTitle())) && (b.fillStyle = h ? f.NODE_SELECTED_TITLE_COLOR : a.constructor.title_text_color || this.node_title_color, a.flags.collapsed ? (b.textAlign = "left", b.measureText(g), b.fillText(g.substr(0, 20), e, f.NODE_TITLE_TEXT_Y - e), b.textAlign = "left") : (b.textAlign = "left", b.fillText(g, e, f.NODE_TITLE_TEXT_Y - e)));
      a.flags.collapsed || !a.subgraph || a.skip_subgraph_button || (g = f.NODE_TITLE_HEIGHT, q = a.size[0] - g, n = f.isInsideRectangle(this.graph_mouse[0] - a.pos[0], this.graph_mouse[1] - a.pos[1], q + 2, -g + 2, g - 4, g - 4), b.fillStyle = n ? "#888" : "#555", l == f.BOX_SHAPE || k ? b.fillRect(q + 2, -g + 2, g - 4, g - 4) : (b.beginPath(), b.roundRect(q + 2, -g + 2, g - 4, g - 4, 4), b.fill()), b.fillStyle = "#333", b.beginPath(), b.moveTo(q + 0.2 * g, 0.6 * -g), b.lineTo(q + 0.8 * g, 0.6 * 
      -g), b.lineTo(q + 0.5 * g, 0.3 * -g), b.fill());
      if (a.onDrawTitle) {
        a.onDrawTitle(b);
      }
    }
    if (h) {
      ...
      t == f.TRANSPARENT_TITLE && (w[1] -= e, w[3] += e);
      b.lineWidth = 1;
      b.globalAlpha = 0.8;
      b.beginPath();
      l == f.BOX_SHAPE ? b.rect(-6 + w[0], -6 + w[1], 12 + w[2], 12 + w[3]) : l == f.ROUND_SHAPE || l == f.CARD_SHAPE && a.flags.collapsed ? b.roundRect(-6 + w[0], -6 + w[1], 12 + w[2], 12 + w[3], 2 * this.round_radius) : l == f.CARD_SHAPE ? b.roundRect(-6 + w[0], -6 + w[1], 12 + w[2], 12 + w[3], 2 * this.round_radius, 2) : l == f.CIRCLE_SHAPE && b.arc(0.5 * c[0], 0.5 * c[1], 0.5 * c[0] + 6, 0, 2 * Math.PI);
  ...
  var I = new Float32Array(4), y = new Float32Array(4), L = new Float32Array(2), M = new Float32Array(2);
      ...
      if (h.inputs && h.inputs.length) {
        for (var g = 0; g < h.inputs.length; ++g) {
          ...
          if (k && null != k.link && (k = this.graph.links[k.link])) {
            ...
            if (null != l) {
              var t = k.origin_slot;
              var q = -1 == t ? [l.pos[0] + 10, l.pos[1] + 10] : l.getConnectionPos(!1, t, L);
              var n = h.getConnectionPos(!0, g, M);
              y[0] = q[0];
              y[1] = q[1];
              y[2] = n[0] - q[0];
              y[3] = n[1] - q[1];
              0 > y[2] && (y[0] += y[2], y[2] = Math.abs(y[2]));
              0 > y[3] && (y[1] += y[3], y[3] = Math.abs(y[3]));
              if (H(y, I)) {
                var m = l.outputs[t];
                t = h.inputs[g];
                if (m && t && (l = m.dir || (l.horizontal ? f.DOWN : f.RIGHT), t = t.dir || (h.horizontal ? f.UP : f.LEFT), this.renderLink(a, q, n, k, !1, 0, null, l, t), k && k._last_time && 1000 > b - k._last_time)) {
                  m = 2.0 - 0.002 * (b - k._last_time);
                  var v = a.globalAlpha;
                  a.globalAlpha = v * m;
                  this.renderLink(a, q, n, k, !0, m, "white", l, t);
                  a.globalAlpha = v;
                }
              }
            }
  ...
  m.prototype.renderLink = function(a, b, c, d, e, h, g, k, l, t) {
    d && this.visible_links.push(d);
    !g && d && (g = d.color || m.link_type_colors[d.type]);
    ...
    for (var n = 0; n < t; n += 1) {
      ...
      if (this.links_render_mode == f.SPLINE_LINK) {
        ...
        a.bezierCurveTo(b[0] + v, b[1] + r + p, c[0] + u, c[1] + D + p, c[0], c[1] + p);
      } else {
        if (this.links_render_mode == f.LINEAR_LINK) {
          ...
          a.lineTo(b[0] + 15 * v, b[1] + 15 * r + p);
          a.lineTo(c[0] + 15 * u, c[1] + 15 * D + p);
          a.lineTo(c[0], c[1] + p);
        } else {
          if (this.links_render_mode == f.STRAIGHT_LINK) {
            a.moveTo(b[0], b[1]), p = b[0], v = b[1], r = c[0], u = c[1], k == f.RIGHT ? p += 10 : v += 10, l == f.LEFT ? r -= 10 : u -= 10, a.lineTo(p, v), a.lineTo(0.5 * (p + r), v), a.lineTo(0.5 * (p + r), u), a.lineTo(r, u), a.lineTo(c[0], c[1]);
          } else {
            return;
          }
        }
    ...
    a.stroke();
    e = this.computeConnectionPoint(b, c, 0.5, k, l);
    d && d._pos && (d._pos[0] = e[0], d._pos[1] = e[1]);
    0.6 <= this.ds.scale && this.highquality_render && l != f.CENTER && (this.render_connection_arrows && (n = this.computeConnectionPoint(b, c, 0.25, k, l), q = this.computeConnectionPoint(b, c, 0.26, k, l), d = this.computeConnectionPoint(b, c, 0.75, k, l), t = this.computeConnectionPoint(b, c, 0.76, k, l), this.render_curved_connections ? (q = -Math.atan2(q[0] - n[0], q[1] - n[1]), t = -Math.atan2(t[0] - d[0], t[1] - d[1])) : t = q = c[1] > b[1] ? 0 : Math.PI, a.save(), a.translate(n[0], n[1]), 
    a.rotate(q), a.beginPath(), a.moveTo(-5, -3), a.lineTo(0, 7), a.lineTo(5, -3), a.fill(), a.restore(), a.save(), a.translate(d[0], d[1]), a.rotate(t), a.beginPath(), a.moveTo(-5, -3), a.lineTo(0, 7), a.lineTo(5, -3), a.fill(), a.restore()), a.beginPath(), a.arc(e[0], e[1], 5, 0, 2 * Math.PI), a.fill());
    if (h) {
      for (a.fillStyle = g, n = 0; 5 > n; ++n) {
        h = (0.001 * f.getTime() + 0.2 * n) % 1, e = this.computeConnectionPoint(b, c, h, k, l), a.beginPath(), a.arc(e[0], e[1], 5, 0, 2 * Math.PI), a.fill();
      }
    }
  };
  m.prototype.computeConnectionPoint = function(a, b, c, d, e) {
    d = d || f.RIGHT;
    e = e || f.LEFT;
    var h = J(a, b), g = [a[0], a[1]], k = [b[0], b[1]];
    switch(d) {
      case f.LEFT:
        g[0] += -0.25 * h;
        break;
    ...
    h = 3 * (1 - c) * c * c;
    c *= c * c;
    return [d * a[0] + e * g[0] + h * k[0] + c * b[0], d * a[1] + e * g[1] + h * k[1] + c * b[1]];
  };
  ...
  m.prototype.drawNodeWidgets = function(a, b, c, d) {
    if (!a.widgets || !a.widgets.length) {
      return 0;
    }
    var e = a.size[0], h = a.widgets;
    b += 2;
    var g = f.NODE_WIDGET_HEIGHT, k = 0.5 < this.ds.scale;
    c.save();
    c.globalAlpha = this.editor_alpha;
    for (var l = f.WIDGET_OUTLINE_COLOR, t = f.WIDGET_BGCOLOR, q = f.WIDGET_TEXT_COLOR, n = f.WIDGET_SECONDARY_TEXT_COLOR, m = 0; m < h.length; ++m) {
      var v = h[m], p = b;
      v.y && (p = v.y);
      v.last_y = p;
      c.strokeStyle = l;
      c.fillStyle = "#222";
      c.textAlign = "left";
      v.disabled && (c.globalAlpha *= 0.5);
      var r = v.width || e;
      switch(v.type) {
        case "button":
          v.clicked && (c.fillStyle = "#AAA", v.clicked = !1, this.dirty_canvas = !0);
          c.fillRect(15, p, r - 30, g);
          k && !v.disabled && c.strokeRect(15, p, r - 30, g);
          k && (c.textAlign = "center", c.fillStyle = q, c.fillText(v.name, 0.5 * r, p + 0.7 * g));
          break;
        case "toggle":
          c.textAlign = "left";
          c.strokeStyle = l;
          c.fillStyle = t;
          c.beginPath();
          k ? c.roundRect(15, b, r - 30, g, 0.5 * g) : c.rect(15, b, r - 30, g);
          c.fill();
          k && !v.disabled && c.stroke();
          c.fillStyle = v.value ? "#89A" : "#333";
          c.beginPath();
          c.arc(r - 30, p + 0.5 * g, 0.36 * g, 0, 2 * Math.PI);
          c.fill();
          k && (c.fillStyle = n, null != v.name && c.fillText(v.name, 30, p + 0.7 * g), c.fillStyle = v.value ? q : n, c.textAlign = "right", c.fillText(v.value ? v.options.on || "true" : v.options.off || "false", r - 40, p + 0.7 * g));
          break;
        case "slider":
          c.fillStyle = t;
          c.fillRect(15, p, r - 30, g);
          var u = v.options.max - v.options.min, F = (v.value - v.options.min) / u;
          c.fillStyle = d == v ? "#89A" : "#678";
          c.fillRect(15, p, F * (r - 30), g);
          k && !v.disabled && c.strokeRect(15, p, r - 30, g);
          v.marker && (u = (v.marker - v.options.min) / u, c.fillStyle = "#AA9", c.fillRect(15 + u * (r - 30), p, 2, g));
          k && (c.textAlign = "center", c.fillStyle = q, c.fillText(v.name + "  " + Number(v.value).toFixed(3), 0.5 * r, p + 0.7 * g));
          break;
        case "number":
        case "combo":
          c.textAlign = "left";
          ...
          k ? c.roundRect(15, b, r - 30, g, 0.5 * g) : c.rect(15, b, r - 30, g);
          c.fill();
          k && (v.disabled || c.stroke(), c.fillStyle = q, v.disabled || (c.beginPath(), c.moveTo(31, b + 5), c.lineTo(21, b + 0.5 * g), c.lineTo(31, b + g - 5), c.fill(), c.beginPath(), c.moveTo(r - 15 - 16, b + 5), c.lineTo(r - 15 - 6, b + 0.5 * g), c.lineTo(r - 15 - 16, b + g - 5), c.fill()), c.fillStyle = n, c.fillText(v.name, 35, p + 0.7 * g), c.fillStyle = q, c.textAlign = "right", "number" == v.type ? c.fillText(Number(v.value).toFixed(void 0 !== v.options.precision ? v.options.precision : 
          3), r - 30 - 20, p + 0.7 * g) : (u = v.value, v.options.values && (F = v.options.values, F.constructor === Function && (F = F()), F && F.constructor !== Array && (u = F[v.value])), c.fillText(u, r - 30 - 20, p + 0.7 * g)));
          break;
        case "string":
        case "text":
          c.textAlign = "left";
          ...
          k ? c.roundRect(15, b, r - 30, g, 0.5 * g) : c.rect(15, b, r - 30, g);
          c.fill();
          k && (c.save(), c.beginPath(), c.rect(15, b, r - 30, g), c.clip(), c.stroke(), c.fillStyle = n, null != v.name && c.fillText(v.name, 30, p + 0.7 * g), c.fillStyle = q, c.textAlign = "right", c.fillText(String(v.value).substr(0, 30), r - 30, p + 0.7 * g), c.restore());
          break;
        default:
          v.draw && v.draw(c, a, r, p, g);
      }
      b += (v.computeSize ? v.computeSize(r)[1] : g) + 4;
      c.globalAlpha = this.editor_alpha;
    }
    c.restore();
    c.textAlign = "left";
  };
  m.prototype.processNodeWidgets = function(a, b, c, d) {
    function e(d, e) {
      d.value = e;
      d.options && d.options.property && void 0 !== a.properties[d.options.property] && a.setProperty(d.options.property, e);
      d.callback && d.callback(d.value, l, a, b, c);
    }
    if (!a.widgets || !a.widgets.length) {
      return null;
    }
    for (var h = b[0] - a.pos[0], g = b[1] - a.pos[1], k = a.size[0], l = this, m = this.getCanvasWindow(), q = 0; q < a.widgets.length; ++q) {
      var n = a.widgets[q];
      if (n && !n.disabled) {
        var r = n.computeSize ? n.computeSize(k)[1] : f.NODE_WIDGET_HEIGHT, p = n.width || k;
        if (n == d || !(6 > h || h > p - 12 || g < n.last_y || g > n.last_y + r)) {
          d = n.value;
          switch(n.type) {
            case "button":
              if ("mousemove" === c.type) {
              ...
              n.callback && setTimeout(function() {
                n.callback(n, l, a, b, c);
              }, 20);
              this.dirty_canvas = n.clicked = !0;
              break;
            case "slider":
              m = Math.clamp((h - 10) / (p - 20), 0, 1);
            ...
            case "combo":
              ...
              if ("mousemove" == c.type && "number" == n.type) {
                ...
                if ("mousedown" == c.type) {
                  ...
                  h = 40 > h ? -1 : h > p - 40 ? 1 : 0;
                  if ("number" == n.type) {
                    n.value += 0.1 * h * (n.options.step || 1), null != n.options.min && n.value < n.options.min && (n.value = n.options.min), null != n.options.max && n.value > n.options.max && (n.value = n.options.max);
                  } else {
                    if (h) {
                      m = -1, this.last_mouseclick = 0, m = u.constructor === Object ? w.indexOf(String(n.value)) + h : w.indexOf(n.value) + h, m >= w.length && (m = w.length - 1), 0 > m && (m = 0), n.value = u.constructor === Array ? u[m] : m;
                    } else {
                      var D = u != w ? Object.values(u) : u;
                      new f.ContextMenu(D, {scale:Math.max(1, this.ds.scale), event:c, className:"dark", callback:function(a, b, c) {
                        u != w && (a = D.indexOf(a));
                        this.value = a;
                        e(this, a);
                        l.dirty_canvas = !0;
                  ...
                  "mouseup" == c.type && "number" == n.type && (h = 40 > h ? -1 : h > p - 40 ? 1 : 0, 200 > c.click_time && 0 == h && this.prompt("Value", n.value, function(a) {
                    this.value = Number(a);
                    e(this, this.value);
                  }.bind(n), c));
                }
            ...
            case "text":
              ...
              break;
            default:
              n.mouse && (this.dirty_canvas = n.mouse(c, [h, g], a));
          }
          if (d != n.value) {
  ...
  m.prototype.drawGroups = function(a, b) {
    if (this.graph) {
      ...
      for (var c = 0; c < a.length; ++c) {
        var d = a[c];
        if (H(this.visible_area, d._bounding)) {
          b.fillStyle = d.color || "#335";
          b.strokeStyle = d.color || "#335";
          var e = d._pos, h = d._size;
          b.globalAlpha = 0.25 * this.editor_alpha;
          b.beginPath();
          b.rect(e[0] + 0.5, e[1] + 0.5, h[0], h[1]);
          b.fill();
          b.globalAlpha = this.editor_alpha;
          b.stroke();
          b.beginPath();
          b.moveTo(e[0] + h[0], e[1] + h[1]);
          b.lineTo(e[0] + h[0] - 10, e[1] + h[1]);
          b.lineTo(e[0] + h[0], e[1] + h[1] - 10);
          b.fill();
          h = d.font_size || f.DEFAULT_GROUP_FONT_SIZE;
          b.font = h + "px Arial";
          b.fillText(d.title, e[0] + 4, e[1] + h);
        }
      }
      b.restore();
    }
  ...
  m.onMenuAdd = function(a, b, c, d, e) {
    function h(a, b) {
      b = d.getFirstEvent();
    ...
    var g = m.active_canvas, k = g.getCanvasWindow(), l = g.graph;
    if (l) {
      a = f.getNodeTypesCategories(g.filter || l.filter);
      b = [];
      for (var t = 0; t < a.length; t++) {
        if (a[t]) {
          var q = a[t];
          -1 != q.indexOf("::") && (q = q.split("::")[1]);
          b.push({value:a[t], content:q, has_submenu:!0});
        }
      }
      var n = new f.ContextMenu(b, {event:c, callback:function(a, b, c) {
        a = f.getNodeTypesInCategory(a.value, g.filter || l.filter);
        b = [];
        for (var d = 0; d < a.length; d++) {
          a[d].skip_list || b.push({content:a[d].title, value:a[d].type});
        }
        new f.ContextMenu(b, {event:c, callback:h, parentMenu:n}, k);
        return !1;
      }, parentMenu:d}, k);
      return !1;
    }
  ...
  m.showMenuNodeOptionalInputs = function(a, b, c, d, e) {
    if (e) {
      var h = this;
      ...
      if (g.length) {
        return new f.ContextMenu(g, {event:c, callback:function(a, b, c) {
          e && (a.callback && a.callback.call(h, e, a, b, c), a.value && (e.graph.beforeChange(), e.addInput(a.value[0], a.value[1], a.value[2]), e.setDirtyCanvas(!0, !0), e.graph.afterChange()));
        }, parentMenu:d, node:e}, a), !1;
      }
      console.log("no input entries");
    }
  };
  m.showMenuNodeOptionalOutputs = function(a, b, c, d, e) {
    function h(a, b, c) {
      if (e && (a.callback && a.callback.call(g, e, a, b, c), a.value)) {
        if (c = a.value[1], !c || c.constructor !== Object && c.constructor !== Array) {
          ...
          new f.ContextMenu(a, {event:b, callback:h, parentMenu:d, node:e});
          return !1;
        }
      }
    }
    if (e) {
      ...
      if (k.length) {
        return new f.ContextMenu(k, {event:c, callback:h, parentMenu:d, node:e}, a), !1;
      }
    }
  };
  m.onShowMenuNodeProperties = function(a, b, c, d, e) {
    if (e && e.properties) {
      var h = m.active_canvas;
      b = h.getCanvasWindow();
      var g = [], k;
      for (k in e.properties) {
        a = void 0 !== e.properties[k] ? e.properties[k] : " ";
        "object" == typeof a && (a = JSON.stringify(a));
        var l = e.getPropertyInfo(k);
        if ("enum" == l.type || "combo" == l.type) {
          a = m.getPropertyPrintableValue(a, l.values);
        }
        a = m.decodeHTML(a);
        g.push({content:"<span class='property_name'>" + k + "</span><span class='property_value'>" + a + "</span>", value:k});
      }
      if (g.length) {
  ...
  m.onResizeNode = function(a, b, c, d, e) {
    if (e) {
  ...
  m.prototype.showLinkMenu = function(a, b) {
    var c = this;
    console.log(a);
    var d = new f.ContextMenu(["Add Node", null, "Delete"], {event:b, title:null != a.data ? a.data.constructor.name : null, callback:function(b, h, g) {
      switch(b) {
        case "Add Node":
          m.onMenuAdd(null, null, g, d, function(b) {
  ...
  m.onShowPropertyEditor = function(a, b, c, d, e) {
    function h() {
      var b = l.value;
    ...
    var t = d = -20;
    c && (d -= c.left, t -= c.top);
    event ? (f.style.left = event.clientX + d + "px", f.style.top = event.clientY + t + "px") : (f.style.left = 0.5 * b.width + d + "px", f.style.top = 0.5 * b.height + t + "px");
    f.querySelector("button").addEventListener("click", h);
    b.parentNode.appendChild(f);
  };
  m.prototype.prompt = function(a, b, c, d) {
    var e = this;
    a = a || "";
    var h = !1, g = document.createElement("div");
    ...
    var l = -20, t = -20;
    b && (l -= b.left, t -= b.top);
    d ? (g.style.left = d.clientX + l + "px", g.style.top = d.clientY + t + "px") : (g.style.left = 0.5 * a.width + l + "px", g.style.top = 0.5 * a.height + t + "px");
  ...
  m.prototype.showSearchBox = function(a) {
    ...
    function c(a) {
      ...
      p ? (p = a ? p.nextSibling : p.previousSibling) || (p = b) : p = a ? q.childNodes[0] : q.childNodes[q.childNodes.length];
      ...
      if (c) {
        if (e.onSearchBox) {
          ...
          d = function(a) {
            ...
            return l && b.filter != l ? !1 : -1 !== a.toLowerCase().indexOf(c);
          };
          var k = 0;
          c = c.toLowerCase();
          var l = h.filter || h.graph.filter;
          for (g in f.searchbox_extras) {
            var t = f.searchbox_extras[g];
            if (-1 !== t.desc.toLowerCase().indexOf(c)) {
              var p = f.registered_node_types[t.type];
              if (!p || p.filter == l) {
                if (a(t.desc, "searchbox_extra"), -1 !== m.search_limit && k++ > m.search_limit) {
                  break;
                }
              }
            }
          ...
          if (Array.prototype.filter) {
            t = Object.keys(f.registered_node_types).filter(d);
          } else {
            for (g in t = [], f.registered_node_types) {
              d(g) && t.push(g);
            }
          }
          for (g = 0; g < t.length && !(a(t[g]), -1 !== m.search_limit && k++ > m.search_limit); g++) {
          }
        }
      }
    }
    var e = this, h = m.active_canvas, g = h.canvas, k = g.ownerDocument || document, l = document.createElement("div");
    ...
    e.search_box = l;
    var q = l.querySelector(".helper"), n = null, r = null, p = null, u = l.querySelector("input");
    ...
    k.fullscreenElement ? k.fullscreenElement.appendChild(l) : (k.body.appendChild(l), k.body.style.overflow = "hidden");
    g = g.getBoundingClientRect();
    var w = (a ? a.clientY : g.top + 0.5 * g.height) - 20;
    l.style.left = (a ? a.clientX : g.left + 0.5 * g.width) - 80 + "px";
    l.style.top = w + "px";
    a.layerY > g.height - 200 && (q.style.maxHeight = g.height - a.layerY - 20 + "px");
    u.focus();
    return l;
  };
  m.prototype.showEditPropertyValue = function(a, b, c) {
    ...
    function e(d) {
      h && h.values && h.values.constructor === Object && void 0 != h.values[d] && (d = h.values[d]);
    ...
    if (a && void 0 !== a.properties[b]) {
      ...
      if ("string" == g || "number" == g || "array" == g || "object" == g) {
        ...
        if ("enum" != g && "combo" != g || !h.values) {
          ...
          for (var l in h.values) {
            var m = l;
            h.values.constructor === Array && (m = h.values[l]);
            f += "<option value='" + m + "' " + (m == a.properties[b] ? "selected" : "") + ">" + h.values[l] + "</option>";
          }
          f += "</select>";
        }
      }
      var q = this.createDialog("<span class='name'>" + b + "</span>" + f + "<button>OK</button>", c);
      if ("enum" != g && "combo" != g || !h.values) {
        if ("boolean" == g) {
          (n = q.querySelector("input")) && n.addEventListener("click", function(a) {
            e(!!n.checked);
          });
        } else {
          if (n = q.querySelector("input")) {
            n.addEventListener("blur", function(a) {
              this.focus();
            }), m = void 0 !== a.properties[b] ? a.properties[b] : "", m = JSON.stringify(m), n.value = m, n.addEventListener("keydown", function(a) {
              13 == a.keyCode && (d(), a.preventDefault(), a.stopPropagation());
            });
          }
        }
      } else {
        var n = q.querySelector("select");
  ...
  m.prototype.createPanel = function(a, b) {
    ...
    d.addWidget = function(a, b, g, k, l) {
      function e(a, b) {
      ...
      var p = n.querySelector(".property_value");
      p.innerText = h;
      ...
      if ("boolean" == a) {
        ...
        if ("string" == a || "number" == a) {
          p.setAttribute("contenteditable", !0), p.addEventListener("keydown", function(a) {
          ...
          if ("enum" == a || "combo" == a) {
            h = m.getPropertyPrintableValue(g, k.values);
          }
        }
      }
      p.innerText = h;
      p.addEventListener("click", function(a) {
        ...
        new f.ContextMenu(k.values || [], {event:a, className:"dark", callback:function(a, c, g) {
          d.innerText = a;
          e(b, a);
          return !1;
        }}, c);
  ...
  m.onMenuNodeCollapse = function(a, b, c, d, e) {
    e.graph.beforeChange(e);
    e.collapse();
    e.graph.afterChange(e);
  };
  m.onMenuNodePin = function(a, b, c, d, e) {
    e.pin();
  };
  m.onMenuNodeMode = function(a, b, c, d, e) {
  ...
  m.onMenuNodeColors = function(a, b, c, d, e) {
    if (!e) {
      throw "no node for color";
    }
    b = [];
    b.push({value:null, content:"<span style='display: block; padding-left: 4px;'>No color</span>"});
    for (var h in m.node_colors) {
      a = m.node_colors[h], a = {value:h, content:"<span style='display: block; color: #999; padding-left: 4px; border-left: 8px solid " + a.color + "; background-color:" + a.bgcolor + "'>" + h + "</span>"}, b.push(a);
    }
    new f.ContextMenu(b, {event:c, callback:function(a) {
      e && ((a = a.value ? m.node_colors[a.value] : null) ? e.constructor === f.LGraphGroup ? e.color = a.groupcolor : (e.color = a.color, e.bgcolor = a.bgcolor) : (delete e.color, delete e.bgcolor), e.setDirtyCanvas(!0, !0));
    }, parentMenu:d, node:e});
    return !1;
  };
  m.onMenuNodeShapes = function(a, b, c, d, e) {
    if (!e) {
  ...
  m.onMenuNodeClone = function(a, b, c, d, e) {
  ...
  m.prototype.processContextMenu = function(a, b) {
    var c = this, d = m.active_canvas.getCanvasWindow(), e = null, h = {event:b, callback:function(b, d, e) {
      if (b) {
        if ("Remove Slot" == b.content) {
          ...
          if ("Disconnect Links" == b.content) {
            ...
            if ("Rename Slot" == b.content) {
              b = b.slot;
              var g = b.input ? a.getInputInfo(b.slot) : a.getOutputInfo(b.slot), f = c.createDialog("<span class='name'>Name</span><input autofocus type='text'/><button>OK</button>", d), h = f.querySelector("input");
              h && g && (h.value = g.label || "");
              f.querySelector("button").addEventListener("click", function(a) {
                h.value && (g && (g.label = h.value), c.setDirty(!0));
                f.close();
              });
            }
          }
    ...
    a && (h.title = a.type);
    var g = null;
    a && (g = a.getSlotInPosition(b.canvasX, b.canvasY), m.active_node = a);
  ...
  G.prototype.draw = function(a, b, c, d, e, f) {
    if (c = this.points) {
      this.size = b;
  ...
  G.prototype.getCloserPoint = function(a, b) {
    ...
    b = b || 30;
    for (var d = this.size[0] - 2 * this.margin, e = this.size[1] - 2 * this.margin, f = c.length, g = [0, 0], k = 1000000, l = -1, m = 0; m < f; ++m) {
      var p = c[m];
      g[0] = p[0] * d;
      g[1] = (1.0 - p[1]) * e;
      p = vec2.distance(a, g);
